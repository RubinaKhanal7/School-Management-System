    ...
    <tbody>
        @foreach ($examSchedule as $schedule)
            <tr>
                ...
                <td>
                    <span data-toggle="tooltip" title="Exam Marks" data-original-title="Exam Marks">
                ...
                <td>
                    <span data-toggle="tooltip" title="Edit Marks" data-original-title="Edit Marks">
                        <button type="button" class="btn btn-default btn-xs editMarks"
                            data-exam_schedule_id="{{ $schedule->id }}"
                            data-exam_id="{{ $schedule->examination_id }}"
                            data-subject_id="{{ $schedule->subject_id }}"
                            data-class_id="{{ $schedule->class_id }}"
