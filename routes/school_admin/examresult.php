...
Route::post('exam-results/get-students-marks-for-edit', 'ExamResultController@getStudentMarksForEdit');
Route::post('students-mark/update', [ExamResultController::class, 'update'])->name('students-mark.update');
Route::post('exam-results/get-students-marks-for-edit', [ExamResultController::class, 'getStudentMarksForEdit'])
->name('students-marks.get-for-edit');
